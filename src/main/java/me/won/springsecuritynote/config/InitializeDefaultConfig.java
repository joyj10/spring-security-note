...
import me.won.springsecuritynote.note.NoteService;
import me.won.springsecuritynote.notice.NoticeService;
import me.won.springsecuritynote.user.User;
import me.won.springsecuritynote.user.UserService;
...
/**
 * 초기 상태 등록 Config
 * H2 DB 사용으로 서버를 끄면 데이터 삭제됨
 * 기본 유저와 관리자를 자동 등록 되도록 하는 클래스
 */
@Configuration
...
public class InitializeDefaultConfig {
    ...
    public void initializeDefaultUser() {
        ...
        noteService.saveNote(user, "테스트1", "테스트입니다.");
